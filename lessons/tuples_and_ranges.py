...
# An example of a tuple withoout type aliasing.
goat: tuple[str,int] = ("MJ", 23)

# Typles are squences, so they are 0-indexed
print(goat[0])
print(goat[1])
...
# Tuples, unlike lists, are unmutable
...
# Once we've aliased a type, we cna create variables of the type
